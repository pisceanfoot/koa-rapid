const debug = require('debug')('koa-rapid')
...
class KoaRapid extends events.EventEmitter {
  constructor() {
    super()
  ...
  _app_root() {
    var appRoot = (function (_rootPath) {
      ...
      module.parent.parent
        ? module.parent.parent.paths[0]
        : module.parent.paths[0]
    )
  ...
  mount() {
    ...
    if (this.optionValue('post-mount')) {
      this.optionValue('post-mount')(this.app)
    }
